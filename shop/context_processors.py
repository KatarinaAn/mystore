...
# создаем контекстный процессор, который выводит разделы на всех страницах сайта
def add_default_data(request):
    ...
    try:
        ...
        pass
    return {'sections': sections, 'search_form': search_form, 'count_in_cart': count_in_cart,
