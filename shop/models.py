...
class Section(models.Model):
    title = models.CharField(
        max_length=70,
        help_text='Тут надо ввести данные из раздела',
        unique=True,
    ...
    # функция формирует и подставляет в ссылки нужный url
...
class Product(models.Model):
    ...
    # фукция считает окончательную сумму по нескольким товарам в корзине
